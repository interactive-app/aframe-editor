...
UI.Texture = function ( mapping ) {
  ...
  canvas.addEventListener( 'click', function ( event ) {
    ...
    aframeEditor.editor.signals.showModal.dispatch(text);
...
UI.Texture.prototype.setValue = function ( mapValue ) {
  ...
  if (url) {
    ...
    aframeEditor.editor.sceneEl.systems.material.textureCache[url]['1 1'].then(paintPreview);
  } else if (mapValue[0] == '#') {
